      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button className="bg-yellow-400 hover:bg-yellow-500 text-neutral-900 font-bold h-14 px-8 text-lg rounded-none">
              SOLICITĂ FINANȚARE
            </Button>
            <Button variant="ghost" className="text-white font-bold h-14 px-8 text-lg rounded-none hover:bg-white/10">
              VEZI CONDIȚIILE
            </Button>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative bg-white/5 border border-white/10 backdrop-blur-md p-10 flex flex-col items-center text-center rounded-sm"
        >
          ...
          <div className="text-white/40 text-sm uppercase tracking-tighter mb-2">DOBÂNDĂ ANUALĂ</div>
